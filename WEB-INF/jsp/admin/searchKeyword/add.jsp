            ...
            <div class="row-fluid">
                <form action="admin/searchKeywords/add" method="post" id="basic_validate" name="basic_validate" class="form-horizontal" novalidate="novalidate">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea id="keyword" name="keyword" class="input-xlarge" style="height: 100px;" placeholder="可批量添加,以英文逗号分隔"></textarea>
                        </div>
                        </div>
                        </div>
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="putNum" name="putNum" class="input-xlarge" value="0" placeholder="需大于0"/>
                        </div>
                    </div>
